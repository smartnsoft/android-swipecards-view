    ...
    implements View.OnTouchListener
{
  ...
  public FlingCardListener(SwipeCardView parent, View frame, Object itemAtPosition, float rotation_degrees,
  ...
  private void onSelectedY(final boolean isTop, float exitX, int duration)
  {
    ...
    this.frame.animate()
        ...
        .rotation(getExitRotation(isTop));
  }

  public void onSelectedX(final boolean isLeft, float exitY, long duration)
  {
