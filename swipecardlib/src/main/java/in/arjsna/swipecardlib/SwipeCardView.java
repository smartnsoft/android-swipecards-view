    ...
    extends BaseFlingAdapterView
{
  ...
  private float SCALE_OFFSET = 0.04f;
  ...
  public SwipeCardView(Context context, AttributeSet attrs, int defStyle)
  {
    ...
    SCALE_OFFSET = a.getFloat(R.styleable.SwipeCardView_translation_offset, 0.04f);
    TRANS_OFFSET = a.getFloat(R.styleable.SwipeCardView_translation_value, -45);
    a.recycle();
  }
  ...
  private void setTopView()
  {
    if (getChildCount() > 0)
    {
      ...
      if (mActiveCard != null)
      {
        ...
        flingCardListener = new FlingCardListener(this, mActiveCard, mAdapter.getItem(START_STACK_FROM), ROTATION_DEGREES, new FlingCardListener.FlingListener()
        {
